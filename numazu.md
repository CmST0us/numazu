...
* **在排计划的时候发现Google Map的行程规划没有非常完全的公共交通数据，所以实际时刻表还是以官方数据，或者换乘案内的数据为准**

## 成田T3到神田
1. 查了一下成田机场官网，香草航空是T3到达的。预计是20:45分到达，预留1小时buffer。按照21:30分机场出发去秋叶原。实际搭乘线路到时候到达后按照下面的优先级去对应站点乘车就行。

https://goo.gl/maps/ZimmfnUavkF2
价格：JP¥ 1030，RMB¥ 63

![成田到日暮里](image/成田到日暮里.png)
![成田到日暮里站点时刻表.png](image/成田到日暮里站点时刻表.png)
2. 成田到达后，向指示 铁道 方向走（T2 地下一楼）
3. 走京成本线，可刷suica

到日暮里后，看时间选JY JK, JP¥160， 10分钟左右到神田
...
到日暮里后看时间做哪条线 https://www.youtube.com/watch?v=yKfLIII4F4s
